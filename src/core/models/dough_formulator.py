...
class DoughFormulator:
            ...
            self.ingredients_db = {
                "vegetables": {
                    "beetroot": Ingredient(
                        name="beetroot",
                        color="red",
                        nutritional_value={"protein": 1.6, "fiber": 2.8, "fat": 0.2, "carbohydrates": 9.6},
                        cost=2.5,
                        availability=0.8,
        ...
        for category, ingredients in self.ingredients_db.items():
            for name, ingredient in ingredients.items():
                ...
                formulation = DoughFormulation(
                    ...
                    nutritional_profile=self._calculate_nutritional_profile(proportions, ingredient),
    ...
    def _calculate_initial_proportions(self, ingredient: Ingredient, target_properties: Dict[str, float]) -> List[float]:
    ...
    def _calculate_nutritional_profile(self, proportions: List[float], ingredient: Ingredient) -> Dict[str, float]:
