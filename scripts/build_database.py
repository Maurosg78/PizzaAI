...
INGREDIENTS = [
    'chickpea flour', 'white rice flour', 'brown rice flour', 'tapioca starch', 'potato starch',
    'corn starch', 'xanthan gum', 'guar gum', 'water', 'olive oil', 'coconut oil', 'sunflower oil',
    'sea salt', 'cane sugar', 'coconut sugar', 'honey', 'maple syrup', 'apple cider vinegar', 
    'dry yeast', 'baking powder', 'baking soda', 'chia seeds', 'flaxseed meal', 'psyllium husk', 
    'almond flour', 'coconut flour', 'quinoa flour', 'buckwheat flour', 'sorghum flour', 'teff flour',
    'millet flour', 'arrowroot starch', 'sweet potato starch', 'cassava starch', 'agar agar', 'pectin',
    'lemon juice', 'orange juice', 'carrot juice', 'beet juice', 'spinach juice', 'tomato juice',
    'turmeric powder', 'cinnamon', 'ginger powder', 'paprika', 'cumin', 'coriander', 'oregano', 
    'thyme', 'basil', 'rosemary', 'garlic powder', 'onion powder', 'black pepper', 'vanilla extract',
    'cocoa powder', 'carob powder', 'nutritional yeast', 'pumpkin puree', 'sweet potato puree', 
    'zucchini puree', 'carrot puree', 'spinach puree', 'beet puree', 'tomato puree', 'cauliflower puree',
    'broccoli puree', 'kale puree', 'pea flour', 'lentil flour', 'fava bean flour', 'amaranth flour',
    'flaxseed flour', 'sunflower seed flour', 'pumpkin seed flour', 'sesame seed flour', 'hemp seed flour',
    'oat bran', 'rice bran', 'millet bran', 'coconut water', 'apple sauce', 'aquafaba', 'mashed banana',
    'spirulina powder', 'chlorella powder', 'wheat flour', 'rye flour', 'barley flour', 'spelt flour'
]
...
def get_nutritional_data(fdc_id):
    ...
    try:
        ...
        data['contains_allergens'] = CLASSIFICATION.get(ingredient, {'alergenos': 'No'})['alergenos']
        return data
    except Exception as e:
...
if database:
    df = pd.DataFrame(database, columns=['ingredient', 'calories', 'protein', 'carbs', 'fat', 'fiber', 'sodium', 'contains_gluten', 'contains_allergens'])
