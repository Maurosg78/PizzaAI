...
ingredients = [
    'cauliflower', 'chickpea flour', 'rice flour', 'potato flour', 'corn starch',
    'olive oil', 'salt', 'water', 'xanthan gum', 'sugar',
    'almond flour', 'coconut flour', 'oat flour (gluten-free)', 'quinoa flour',
    'buckwheat flour', 'lentil flour', 'corn flour', 'potato starch',
    'tapioca starch', 'psyllium husk', 'flaxseed meal'
]

# Obtener datos y guardarlos
data = [get_nutritional_data(ing, api_key) for ing in ingredients if get_nutritional_data(ing, api_key)]
